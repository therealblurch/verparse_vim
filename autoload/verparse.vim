...
function! verparse#VPSignalSearch()
   ...
   let s:VPTargetFile = strpart(s:VPOutput,s:VPReturn2+1,s:VPSpace2-s:VPReturn2)
...
function! verparse#VPDefineSearch()
   ...
   let s:VPLastReturn = strridx(s:VPOutput, "\n")
   let s:VPReturn2 = strridx(s:VPOutput, "\n", s:VPLastReturn-1)
   let s:VPDefine = strpart(s:VPOutput, s:VPReturn2+1,strlen(s:VPOutput)-s:VPReturn2-1)
   echo s:VPDefine
endfunction
